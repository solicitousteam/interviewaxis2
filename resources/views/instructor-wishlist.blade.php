                                                    ...
                                                    <div class="course-group d-flex">
                                                        <div class="course-group-img d-flex">
                                                            ...
                                                            <div class="course-name">
                                                                <h4><a href="{{ url('instructor-profile') }}">Cooper</a>
                                                                </h4>
                                                                <p>Instructor</p>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <a href="#"><i
                                                                    class="fa-regular fa-heart color-active"></i></a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="course-box flex-fill">
                                            <div class="product">
                                                ...
                                                <div class="product-content">
                                                    <div class="course-group d-flex">
                                                        <div class="course-group-img d-flex">
                                                            <a href="{{ url('instructor-profile') }}"><img
                                                                    ...
                                                                    alt="" class="img-fluid"></a>
                                                            <div class="course-name">
                                                                <h4><a href="{{ url('instructor-profile') }}">Jenny</a>
                                                                </h4>
                                                                <p>Instructor</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <h3 class="title instructor-text"><a
                                                            href="{{ url('course-details') }}">Sketch from A to Z (2022):
                                        ...
                                        <div class="course-box flex-fill">
                                            <div class="product">
                                                ...
                                                <div class="product-content">
                                                    <div class="course-group d-flex">
                                                        <div class="course-group-img d-flex">
                                                            <a href="{{ url('instructor-profile') }}"><img
                                                                    ...
                                                                    alt="" class="img-fluid"></a>
                                                            <div class="course-name">
                                                                <h4><a href="{{ url('instructor-profile') }}">Nicole
                                                                        Brown</a></h4>
                                                                <p>Instructor</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <h3 class="title instructor-text"><a
                                                            href="{{ url('course-details') }}">Learn Angular Fundamentals
                                        ...
                                        <div class="course-box flex-fill">
                                            <div class="product">
                                                ...
                                                <div class="product-content">
                                                    <div class="course-group d-flex">
                                                        <div class="course-group-img d-flex">
                                                            <a href="{{ url('instructor-profile') }}"><img
                                                                    ...
                                                                    alt="" class="img-fluid"></a>
                                                            <div class="course-name">
                                                                <h4><a href="{{ url('instructor-profile') }}">John
                                                                        Smith</a></h4>
                                                                <p>Instructor</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <h3 class="title instructor-text"><a
                                                            href="{{ url('course-details') }}">Build Responsive Real World
                                                            Websites with Crash Course</a></h3>
                                                    <div class="course-info d-flex align-items-center">
                                                        <div class="rating-img d-flex align-items-center">
                                                            <img src="{{ URL::asset('/build/img/icon/icon-01.svg') }}"
                                                                alt="">
                                        ...
                                        <div class="course-box flex-fill">
                                            <div class="product">
                                                ...
                                                <div class="product-content">
                                                    <div class="course-group d-flex">
                                                        <div class="course-group-img d-flex">
                                                            <a href="{{ url('instructor-profile') }}"><img
                                                                    ...
                                                                    alt="" class="img-fluid"></a>
                                                            <div class="course-name">
                                                                <h4><a href="{{ url('instructor-profile') }}">Stella
                                                                        Johnson</a></h4>
                                                                <p>Instructor</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <h3 class="title instructor-text"><a
                                                            href="{{ url('course-details') }}">Learn JavaScript and
