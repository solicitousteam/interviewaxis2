							...
							<div class="breadcrumb-list">
								<nav aria-label="breadcrumb" class="page-breadcrumb">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item">Instructors Grid</li>
									</ol>
								</nav>
							</div>
						</div>
									...
									<div class="col-lg-6">
										<div class="d-flex align-items-center">
											<div class="view-icons">
												...
												<a href="{{url('instructor-list')}}" class="list-view"><i class="feather-list"></i></a>
											</div>
							...
							<div class="row">
									...
									<div class="instructor-box flex-fill">
										<div class="instructor-img">
											<a href="{{url('instructor-profile')}}">
												<img class="img-fluid" alt="Img" src="{{URL::asset('/build/img/user/user11.jpg')}}">
											</a>
										...
										<div class="instructor-content">												
											...
											<div class="rating-img d-flex align-items-center justify-content-center">
												<img src="{{URL::asset('/build/img/icon/icon-01.svg')}}" class="me-1" alt="Img">
												<p>12+ Lesson</p>
											</div>
											<div class="course-view d-flex align-items-center justify-content-center">
												<img src="{{URL::asset('/build/img/icon/icon-02.svg')}}" class="me-1" alt="Img">
												<p>9hr 30min</p>
											</div>
											<div class="rating">							
								...
								<div class="col-lg-4 col-md-6 d-flex">
									<div class="instructor-box flex-fill">
										<div class="instructor-img">
											<a href="{{url('instructor-profile')}}">
												<img class="img-fluid" alt="Img" src="{{URL::asset('/build/img/user/user.jpg')}}">
											</a>
											<a href="#rate" class="rating-count"><i class="fa-regular fa-heart"></i></a>
										</div>
										<div class="instructor-content">												
								...
								<div class="col-lg-4 col-md-6 d-flex">
									<div class="instructor-box flex-fill">
										<div class="instructor-img">
											<a href="{{url('instructor-profile')}}">
												<img class="img-fluid" alt="Img" src="{{URL::asset('/build/img/user/user4.jpg')}}">
											</a>
											<a href="#rate" class="rating-count"><i class="fa-regular fa-heart"></i></a>
										</div>
										<div class="instructor-content">												
								...
								<div class="col-lg-4 col-md-6 d-flex">
									<div class="instructor-box flex-fill">
										<div class="instructor-img">
											<a href="{{url('instructor-profile')}}">
												<img class="img-fluid" alt="Img" src="{{URL::asset('/build/img/user/user2.jpg')}}">
											</a>
											<a href="#rate" class="rating-count"><i class="fa-regular fa-heart"></i></a>
										</div>
										<div class="instructor-content">												
								...
								<div class="col-lg-4 col-md-6 d-flex">
									<div class="instructor-box flex-fill">
										<div class="instructor-img">
											<a href="{{url('instructor-profile')}}">
												<img class="img-fluid" alt="Img" src="{{URL::asset('/build/img/user/user3.jpg')}}">
											</a>
											<a href="#rate" class="rating-count"><i class="fa-regular fa-heart"></i></a>
										</div>
										<div class="instructor-content">												
								...
								<div class="col-lg-4 col-md-6 d-flex">
									<div class="instructor-box flex-fill">
										<div class="instructor-img">
											<a href="{{url('instructor-profile')}}">
												<img class="img-fluid" alt="Img" src="{{URL::asset('/build/img/user/user5.jpg')}}">
											</a>
											<a href="#rate" class="rating-count"><i class="fa-regular fa-heart"></i></a>
										</div>
										<div class="instructor-content">												
								...
								<div class="col-lg-4 col-md-6 d-flex">
									<div class="instructor-box flex-fill">
										<div class="instructor-img">
											<a href="{{url('instructor-profile')}}">
												<img class="img-fluid" alt="Img" src="{{URL::asset('/build/img/user/user12.jpg')}}">
											</a>
											<a href="#rate" class="rating-count"><i class="fa-regular fa-heart"></i></a>
										</div>
										<div class="instructor-content">												
								...
								<div class="col-lg-4 col-md-6 d-flex">
									<div class="instructor-box flex-fill">
										<div class="instructor-img">
											<a href="{{url('instructor-profile')}}">
												<img class="img-fluid" alt="Img" src="{{URL::asset('/build/img/user/user1.jpg')}}">
											</a>
											<a href="#rate" class="rating-count"><i class="fa-regular fa-heart"></i></a>
										</div>
										<div class="instructor-content">												
								...
								<div class="col-lg-4 col-md-6 d-flex">
									<div class="instructor-box flex-fill">
										<div class="instructor-img">
											<a href="{{url('instructor-profile')}}">
												<img class="img-fluid" alt="Img" src="{{URL::asset('/build/img/user/user13.jpg')}}">
											</a>
											<a href="#rate" class="rating-count"><i class="fa-regular fa-heart"></i></a>
										</div>
										<div class="instructor-content">												
