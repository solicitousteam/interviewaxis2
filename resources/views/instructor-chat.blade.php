                                                    ...
                                                    <div class="add-section">
                                                        ...
                                                        <div class="user-chat-search">
                                                            <form>
                                                                ...
                                                                <div class="user-close-btn-chat"><i class="feather-x"></i>
                                                                </div>
                                                            </form>
                                                        </div>
                                                        <!-- /Chat Search -->
                                                ...
                                                <div class="sidebar-body chat-body" id="chatsidebar">
                                                    ...
                                                    <ul class="user-list">
                                                        <li class="user-list-item chat-user-list">
                                                            <a href="javascript:void(0);">
                                                                <div class="avatar avatar-online">
                                                                    <img src="{{ URL::asset('/build/img/user/user11.jpg') }}"
                                                                        class="rounded-circle" alt="image">
                                                                </div>
                                                                <div class="users-list-body">
                                                                    <div>
                                                        ...
                                                        <li class="user-list-item chat-user-list">
                                                            <a href="javascript:void(0);">
                                                                <div class="avatar">
                                                                    <img src="{{ URL::asset('/build/img/user/user.jpg') }}"
                                                                        class="rounded-circle" alt="image">
                                                                </div>
                                                                <div class="users-list-body">
                                                                    <div>
                                                                        <h5>James Albert</h5>
                                                                        <p><i class="bx bx-file me-1"></i>Project Tools.doc
                                                                        </p>
                                                                    </div>
                                                                    <div class="last-chat-time">
                                                                        <small class="text-muted">10:20 PM</small>
                                                        ...
                                                        <li class="user-list-item chat-user-list">
                                                            <a href="javascript:void(0);">
                                                                <div>
                                                                    <div class="avatar avatar-online">
                                                                        <img src="{{ URL::asset('/build/img/user/user6.jpg') }}"
                                                                            class="rounded-circle" alt="image">
                                                                    </div>
                                                                </div>
                                                                <div class="users-list-body">
                                                        ...
                                                        <li class="user-list-item chat-user-list">
                                                            <a href="javascript:void(0);">
                                                                <div>
                                                                    <div class="avatar avatar-online">
                                                                        <img src="{{ URL::asset('/build/img/user/user13.jpg') }}"
                                                                            class="rounded-circle" alt="image">
                                                                    </div>
                                                                </div>
                                                                <div class="users-list-body">
                                                        ...
                                                        <ul class="list-inline mt-2 me-2">
                                                            <li class="list-inline-item">
                                                                <a class="text-muted px-0 left_sides"
                                                                    href="javascript:void(0);" data-chat="open">
                                                ...
                                                <div class="messages">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <a href="javascript:void(0);"
                                                                                class="dropdown-item message-info-left"><span><i
                                                                                        class="bx bx-info-circle"></i></span>Message
                                                                                Info </a>
                                                                            <a href="javascript:void(0);"
                                                                ...
                                                                <div class="chat-voice-group">
                                                                    <ul>
                                                                        <li><a href="javascript:void(0);"><span><img
                                                                                        src="{{ URL::asset('/build/img/icon/play-01.svg') }}"
                                                                                        alt="image"></span></a></li>
                                                                        <li><img src="{{ URL::asset('/build/img/icon/voice.svg') }}"
                                                                                class="img-fluid" alt="image"></li>
                                                                        <li>0:05</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="chats">
                                                        ...
                                                        <div class="chat-content">
                                                            ...
                                                            <div class="message-content award-link chat-award-link">
                                                                <a
                                                                    href="javascript:void(0);">https://www.youtube.com/watch?v=GCmL3mS0Psk</a>
                                                                <img src="{{ URL::asset('/build/img/chat-img-01.jpg') }}"
                                                    ...
                                                    <div class="chats chats-right">
                                                        <div class="chat-content">
                                                            ...
                                                            <div class="message-content ">
                                                                Thankyou for the notes sir. Will you send me the location
                                                                where I could bought?
                                                            </div>
                                                        </div>
                                                        <div class="chat-avatar">
                                                            <img src="{{ URL::asset('/build/img/user/user2.jpg') }}"
                                                    ...
                                                    <div class="chats">
                                                        ...
                                                        <div class="chat-content">
                                                            ...
                                                            <div class="like-chat-grp">
                                                                <ul>
                                                                    <li class="like-chat"><a
                                                                            href="javascript:void(0);">2<img
                                                                                src="{{ URL::asset('/build/img/icon/like.svg') }}"
                                                                                alt="Icon"></a></li>
                                                                    <li class="comment-chat"><a
                                                                            href="javascript:void(0);">2<img
                                                                                src="{{ URL::asset('/build/img/icon/heart.svg') }}"
                                                                                alt="Icon"></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
