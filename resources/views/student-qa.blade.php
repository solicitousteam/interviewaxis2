										...
										<div class="table-responsive custom-table">
											...
											<table class="table table-nowrap mb-0">
												...
												<tbody>
													<tr>
														<td>Q1</td>
														<td><span  class="title-course">AngularJS and Angular refer to the same framework.</span></td>
													...
													<tr>
														<td>Q2</td>
														<td><span  class="title-course">What is the purpose of Angular's NgIf directive?</span></td>
														<td><span  class="title-course">Learn Angular Fundamentals Beginners Guide</span></td>
														<td>
															<i class="bx bx-check-double"></i>
															<a href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Multiple Choice"><i class="bx bxs-info-circle"></i></a>
														</td>
														<td>March 24, 2024 <span class="d-block">09:30 AM</span></td>
														<td>
															<h2 class="table-avatar d-flex align-items-center">
													...
													<tr>
														<td>Q3</td>
														<td><span  class="title-course">Observables are not part of Angular's HTTP module.</span></td>
														<td><span  class="title-course">Learn Angular Fundamentals Beginners Guide</span></td>
														<td>
															<i class="bx bxs-adjust"></i>
															<a href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="True / False"><i class="bx bxs-info-circle"></i></a>
													...
													<tr>
														<td>Q4</td>
														<td><span  class="title-course">Which of the following is a valid way to bind data in Angular?</span></td>
														<td><span  class="title-course">Learn Angular Fundamentals Beginners Guide</span></td>
														<td>
															<i class="bx bx-check-double"></i>
															<a href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Multiple Choice"><i class="bx bxs-info-circle"></i></a>
													...
													<tr>
														<td>Q5</td>
														<td><span  class="title-course">Angular applications can only be written in TypeScript.</span></td>
														<td><span  class="title-course">Learn Angular Fundamentals Beginners Guide</span></td>
														<td>
															<i class="bx bxs-adjust"></i>
															<a href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="True / False"><i class="bx bxs-info-circle"></i></a>
